  ...
  return (
    <div style={ padding: 0 }>
      <div style={
        ...
        <p style={ fontSize: 13, color: '#64748b', marginTop: 4 }>Priority 2 · Phase 2</p>
      </div>
      ...
      <div style={
        ...
        <p style={ fontSize: 13 }>Dual-line chart overlay: observed gauge readings vs forecast stage/discharge.</p>
      </div>
    </div>
  )
}
